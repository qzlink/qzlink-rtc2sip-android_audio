package com.sdk.android.service;
/*
 * @creator      dean_deng
 * @createTime   2019/7/12 16:12
 * @Desc         ${TODO}
 */
...
import com.sdk.android.ui.ConversationActivity;
...
public class FloatVideoWindowService extends Service {
    ...
    public void onCreate() {
        ...
        boolean callConnect = AppCache.getInstance().isCallConnect();
        if (callConnect) {
            //获取聊天时长
            mTimeSecond = AppCache.getInstance().getSecond();
            //开始计时
    ...
    private void initWindow() {
        ...
        mTvCountTime = mFloatingLayout.findViewById(R.id.tv_count_down);
        // 添加悬浮窗的视图
    ...
    private void initFloating() {
        ...
        smallSizePreviewLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //在这里实现点击重新回到Activity
                Intent intent = new Intent(FloatVideoWindowService.this, ConversationActivity.class);
//                intent.setFlags(FLAG_ACTIVITY_NEW_TASK);
                PendingIntent pendingIntent =
                        PendingIntent.getActivity(FloatVideoWindowService.this, 0, intent, 0);
                try {
                    pendingIntent.send();
    ...
    private class TimeRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (mTvCountTime != null) {
                mTvCountTime.setText(DateTimeUtil.getMSTime(mTimeSecond));
            }
